  ...
  static Future<void> checkForUpdates(BuildContext context) async {
    try {
      final response = await http.get(
        Uri.parse(
            'https://api.github.com/repos/hendrilmendes/Calculadora/releases/latest'),
        headers: {
          ...
          showDialog(
            ...
            builder: (context) => AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  Text(
                    "A versão $latestVersion da Calculadora está disponível. Você esta usando a versão $currentVersion.",
                  ),
                ...
                FilledButton.tonal(
                  onPressed: () {
                    if (Platform.isAndroid) {
                      // Android
                      launchUrl(Uri.parse(
                          'https://play.google.com/store/apps/details?id=com.github.hendrilmendes.calculadora'));
